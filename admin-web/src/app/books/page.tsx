          ...
          <div className="card rounded-2xl p-4 sm:p-5 mb-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-gray-600">Manage digital books and publications</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
              <div className="rounded-xl border border-gray-300/80 dark:border-slate-600/80 bg-white dark:bg-slate-800/90 p-3">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[11px] text-gray-600">Total Books</span>
                ...
                <p className="mt-0.5 text-[11px] text-gray-500">Digital books</p>
              </div>
              <div className="rounded-xl border border-gray-300/80 dark:border-slate-600/80 bg-white dark:bg-slate-800/90 p-3">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[11px] text-gray-600">Premium</span>
                ...
                <p className="mt-0.5 text-[11px] text-gray-500">Paid content</p>
              </div>
              <div className="rounded-xl border border-gray-300/80 dark:border-slate-600/80 bg-white dark:bg-slate-800/90 p-3">
                <div className="flex items-center justify-between mb-1.5">
                ...
                <p className="text-lg font-semibold">{books.filter(b => !b.is_premium).length}</p>
                <p className="mt-0.5 text-[11px] text-gray-500">Free content</p>
              </div>
              <div className="rounded-xl border border-gray-300/80 dark:border-slate-600/80 bg-white dark:bg-slate-800/90 p-3">
                <div className="flex items-center justify-between mb-1.5">
                ...
                <p className="mt-0.5 text-[11px] text-gray-500">Book categories</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 w-full sm:w-80 rounded-xl bg-white/80 dark:bg-slate-800/90 border border-gray-300/80 dark:border-slate-600/80 text-xs text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-blue-400/50 focus:border-blue-500/50 dark:focus:border-blue-400/50"
                  />
                </div>
                <button className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/80 dark:bg-slate-800/90 border border-gray-300/80 dark:border-slate-600/80 text-[11px] font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100/90 dark:hover:bg-slate-700/90">
          ...
          <div className="card rounded-2xl p-4 sm:p-5">
            <div className="overflow-x-auto no-scrollbar">
              <table className="w-full text-left border-separate border-spacing-y-1.5">
                <thead className="text-[10px] uppercase tracking-[.18em] text-gray-500">
                  <tr>
                ...
                <tbody className="text-xs">
                  {loading || bulkLoading ? (
                    ...
                    <tr>
                      <td colSpan={8} className="text-center py-8">
                        <div className="flex flex-col items-center">
                          ...
                          <h3 className="text-sm font-medium text-gray-700 mb-1">No books found</h3>
                    ...
                    filteredBooks.map((book) => (
                      <tr key={book.id} className={`bg-white/90 dark:bg-slate-800/90 hover:bg-white dark:hover:bg-slate-800 transition border border-gray-200/80 dark:border-slate-700/80 ${selectedBooks.includes(book.id) ? 'bg-blue-500/5 dark:bg-blue-500/10' : ''}`}>
                        ...
                        <td className="px-2 py-3">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-white dark:bg-slate-800 flex items-center justify-center border border-gray-300/80 dark:border-slate-600/80">
                              {book.thumbnail_url ? (
                                <img
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-medium text-gray-900 dark:text-white truncate">{book.title}</p>
                              <p className="text-[10px] text-gray-600 dark:text-gray-400 line-clamp-2">{book.description || 'No description'}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-2 py-3">
                          <div className="text-xs text-gray-800 dark:text-gray-200">{book.author}</div>
                        </td>
                        <td className="px-2 py-3">
                          <span className="px-2 py-0.5 rounded-full bg-white dark:bg-slate-800 border border-gray-300/80 dark:border-slate-600/80 text-[10px] text-gray-800 dark:text-gray-200">
                          ...
                          <div className="flex items-center justify-end gap-1">
                            ...
                            {book.pdf_url && (
                              <button
                                ...
                                className="p-1.5 rounded-lg bg-white dark:bg-slate-800 border border-gray-300/80 dark:border-slate-600/80 text-[10px] hover:bg-blue-600/20 dark:hover:bg-blue-600/30 hover:border-blue-500/40 dark:hover:border-blue-400/40 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                title="View PDF"
                              >
                            ...
                            {book.pdf_url && (
                              <button
                                ...
                                className="p-1.5 rounded-lg bg-white dark:bg-slate-800 border border-gray-300/80 dark:border-slate-600/80 text-[10px] hover:bg-green-600/20 dark:hover:bg-green-600/30 hover:border-green-500/40 dark:hover:border-green-400/40 text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors"
                                title="Download PDF"
                              >
                            ...
                            <Link
                              ...
                              className="p-1.5 rounded-lg bg-white dark:bg-slate-800 border border-gray-300/80 dark:border-slate-600/80 text-[10px] hover:bg-amber-600/20 dark:hover:bg-amber-600/30 hover:border-amber-500/40 dark:hover:border-amber-400/40 text-gray-700 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
                              title="Edit Book"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-white dark:bg-slate-800 border border-gray-300/80 dark:border-slate-600/80 text-[10px] hover:bg-rose-600/20 dark:hover:bg-rose-600/30 hover:border-rose-500/40 dark:hover:border-rose-400/40 text-gray-700 dark:text-gray-300 hover:text-rose-300 dark:hover:text-rose-400 disabled:opacity-50 transition-colors"
                              title="Delete Book"
                            >
