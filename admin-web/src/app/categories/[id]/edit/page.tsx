              ...
              <div className="card rounded-2xl p-5 sm:p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 rounded-lg bg-slate-900/80 border ${
                            errors.name ? 'border-rose-500/50' : 'border-slate-700/80'
                          } text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min="0"
                          className={`w-full px-3 py-2 rounded-lg bg-slate-900/80 border ${
                            errors.sort_order ? 'border-rose-500/50' : 'border-slate-700/80'
                          } text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50`}
                          placeholder="0"
                        />
                        {errors.sort_order && (
                    ...
                    <div className="mt-4">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className={`w-full px-3 py-2 rounded-lg bg-slate-900/80 border ${
                          errors.description ? 'border-rose-500/50' : 'border-slate-700/80'
                        } text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 resize-none`}
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1">
                        ...
                        <div className="relative">
                          ...
                          <label
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg border ${
                              errors.icon ? 'border-rose-500/50' : 'border-slate-700/80'
                            } bg-slate-900/80 text-xs text-slate-300 hover:bg-slate-800/90 cursor-pointer transition-colors`}
                          >
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                          Recommended: Square image, at least 256x256px. Max size: 5MB.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        {iconPreview ? (
                          ...
                          <div className="w-16 h-16 rounded-xl bg-slate-800/80 border border-slate-700/80 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-slate-900/80 border border-slate-700/80">
                      <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-slate-800/80">
                    <Link
                      href="/categories"
                      className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-700/80 text-xs text-slate-300 hover:bg-slate-800/90 transition-colors"
                    >
                      Cancel
                    </Link>
