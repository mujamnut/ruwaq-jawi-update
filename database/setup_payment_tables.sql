-- Setup payment and subscription tables for Ruwaq Jawi
...
('monthly_basic', 'Asas Bulanan', 'Akses kepada koleksi kitab asas', 19.90, 'MYR', 30, '["Akses kepada 100+ kitab Islam", "Video kuliah asas", "Akses aplikasi mobile", "Sokongan email"]'),
('monthly_premium', 'Premium Bulanan', 'Akses penuh kepada semua kandungan pendidikan Islam', 39.90, 'MYR', 30, '["Akses kepada 500+ kitab Islam", "Video kuliah premium", "Muat turun offline", "Sokongan keutamaan", "Ciri carian lanjutan"]'),
('yearly_premium', 'Premium Tahunan', 'Akses penuh dengan penjimatan besar', 399.90, 'MYR', 365, '["Akses kepada 500+ kitab Islam", "Video kuliah premium", "Muat turun offline", "Sokongan keutamaan", "Ciri carian lanjutan", "2 bulan percuma"]')
