...
class _AdminReportsScreenState extends State<AdminReportsScreen>
  ...
  Future<void> _loadReportData() async {
    try {
      ...
      final results = await Future.wait<dynamic>([
        ...
        SupabaseService.from('ebooks')
            ...
            .then((ebookData) async {
              ...
              combined.sort((a, b) => DateTime.parse(b['created_at']).compareTo(DateTime.parse(a['created_at'])));
      ...
      // Calculate revenue
      final thisMonthRevenue = thisMonthPayments
          .fold<double>(0, (sum, payment) => sum + ((payment['amount_cents'] ?? 0) / 100));
      final totalRevenueAmount = totalRevenue
          .fold<double>(0, (sum, payment) => sum + ((payment['amount_cents'] ?? 0) / 100));
  ...
  Widget _buildGrowthCard(String title, String value, String percentage, IconData icon, Color color, bool isPositive) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      HugeIcon(
                        icon: isPositive ? HugeIcons.strokeRoundedArrowUp01 : HugeIcons.strokeRoundedArrowDown01,
                        size: 12.0,
  ...
  Widget _buildInfoCard(String title, String value, String description, IconData icon, Color color) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildBreakdownItem(String title, int count, double percentage, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: isEbook ? Colors.blue.withValues(alpha: 0.1) : Colors.green.withValues(alpha: 0.1),
              borderRadius: BorderRadius.circular(10),
            ),
            child: HugeIcon(
              icon: isEbook ? HugeIcons.strokeRoundedBook02 : HugeIcons.strokeRoundedVideo01,
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isEbook ? Colors.blue.shade50 : Colors.green.shade50,
                        borderRadius: BorderRadius.circular(4),
                        border: Border.all(
                          color: isEbook ? Colors.blue.shade200 : Colors.green.shade200,
                        ),
                      ),
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 11,
                          color: isEbook ? Colors.blue.shade700 : Colors.green.shade700,
                          fontWeight: FontWeight.w500,
                        ),
                      ),
                    ),
