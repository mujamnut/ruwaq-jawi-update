...
class _AdminUserDetailScreenState extends State<AdminUserDetailScreen>
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      final videoKitabInteractionsData =
          await SupabaseService.from('video_kitab_user_interactions')
              .select('''
      ...
      setState(() {
        ...
        _ebookInteractions = List<Map<String, dynamic>>.from(
          ebookInteractionsData,
        );
        _videoKitabInteractions = List<Map<String, dynamic>>.from(
          videoKitabInteractionsData,
        );
