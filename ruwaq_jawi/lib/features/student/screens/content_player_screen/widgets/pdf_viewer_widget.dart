...
class PdfViewerWidget extends StatelessWidget {
          ...
          child: Row(
            ...
            children: [
              _buildPdfNavButton(
                ...
                onPressed: currentPdfPage > 1
                    ? () => pdfController?.firstPage()
                    : null,
              ...
              _buildPdfNavButton(
                ...
                onPressed: currentPdfPage < totalPdfPages
  ...
  Widget _buildPdfViewer() {
    ...
    // Fallback - show download prompt or network viewer
