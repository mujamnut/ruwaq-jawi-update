...
class VideoProgressService {
  ...
  static Box<dynamic> get _progressBox {
    if (_box == null || !_box!.isOpen) {
      throw Exception('VideoProgressService not initialized. Call initialize() first.');
    }
    return _box!;
  }

  /// Save video progress position
  static Future<bool> saveVideoPosition(String videoId, int positionSeconds) async {
    try {
      final allProgress = _progressBox.get(_videoProgressKey, defaultValue: <String, dynamic>{}) as Map;
  ...
  static double getProgressPercentage(String videoId, int totalDurationSeconds) {
